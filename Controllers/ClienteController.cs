...
public class ClienteController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("id,Nombres_Cliente,Cedula,Apellidos,Direccion,Telefono,Correo,Celular,fecha_nacimiento,estado_civil,estado")] ClienteModel clientemodel)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("id,Nombres_Cliente,Cedula,Apellidos,Direccion,Telefono,Correo,Celular,fecha_nacimiento,estado_civil,estado")] ClienteModel clientemodel)
    {
